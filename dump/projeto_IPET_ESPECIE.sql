...
CREATE TABLE `ipet_especie` (
  ...
  `ESP_ROEDOR` varchar(6) DEFAULT NULL,
  `ESP_PASSARO` varchar(7) DEFAULT NULL,
  `ESP_TARTARUGA` varchar(9) DEFAULT NULL,
  `ESP_PEIXE` varchar(5) DEFAULT NULL,
  PRIMARY KEY (`ESP_ID`)
...
LOCK TABLES `ipet_especie` WRITE;
/*!40000 ALTER TABLE `ipet_especie` DISABLE KEYS */;
/*!40000 ALTER TABLE `ipet_especie` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-10-25  0:02:20
