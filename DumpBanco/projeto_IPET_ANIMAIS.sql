...
CREATE TABLE `IPET_ANIMAIS` (
  ...
  `ANI_ONG_CODIGO` int DEFAULT NULL,
  `ANI_NOR_CODIGO` int DEFAULT NULL,
  PRIMARY KEY (`ANI_CODIGO`),
  KEY `ANI_ONG_PK` (`ANI_ONG_CODIGO`),
  KEY `ANI_NOR_PK` (`ANI_NOR_CODIGO`),
  CONSTRAINT `ANI_NOR_PK` FOREIGN KEY (`ANI_NOR_CODIGO`) REFERENCES `IPET_USUARIOS_NORMAL` (`NOR_CODIGO`),
  CONSTRAINT `ANI_ONG_PK` FOREIGN KEY (`ANI_ONG_CODIGO`) REFERENCES `IPET_USUARIOS_ONG` (`ONG_CODIGO`)
