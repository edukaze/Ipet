...
<body>
		...
		<div class="content">
			...
			<div  class="teamBx">
				<div class="member">
					...
					<div class="details">
						<div>
							<h2>Desiree<br><span>Gerente</span></h2>
						</div>
					</div>
				</div>
				<div class="member">
				...
				<div class="member">
					...
					<div class="details">
						<div>
							<h2>Matheus<br><span>Back-end</span></h2>
						</div>
					</div>
				</div>
				<div class="member">
					...
					<div class="details">
						<div>
							<h2>Rivaldo<br><span>Back-end</span></h2>
						</div>
					</div>
				</div>
				<div class="member">
					...
					<div class="details">
						<div>
							<h2>Jonas<br><span>Back-end</span></h2>
						</div>
					</div>
				</div>
				<div class="member">
	...
	<section class="sec contact" id="contato">
		<div class="content">
			...
			<div class="sci">
				<ul>
					<li><a href="https://github.com/edukaze/Projeto_e_pratica"><img src="img/git.png"></a></li>
					<li><a href="https://drive.google.com/open?id=1onAAbIkNYK50C1SbLo4ZsexYWmdhic1W"><img src="img/pdf.png"></a></li>	
				</ul>
			</div>
